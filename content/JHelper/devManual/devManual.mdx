...
![img_2](./images/contributing_2.png)

**(작업 시작)**  
Fork를 통해, 원본 레포지토리를 내 레포지토리로 복사합니다.  
![img_1](./images/contributing_1.png)
...
![img_3](./images/contributing_3.png)
...
# 알려진 문제
* Node 20 버전에서 Build 시 Build가 안 되는 문제가 발생합니다.
* Node 16버전이 가장 Stable하게 작동하는 것으로 확인되었습니다.
