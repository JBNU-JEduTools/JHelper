...
<img src="https://github.com/GyuHo123/JHelper/blob/main/images/CONTRIBUTING/contributing_2.png?raw=true" width="800" alt="이슈 생성 화면" />

**(작업 시작)**  
Fork를 통해, 원본 레포지토리를 내 레포지토리로 복사합니다.  
<img src = "https://github.com/GyuHo123/JHelper/blob/main/images/CONTRIBUTING/contributing_1.png?raw=true" width = "800" alt="작업 시작" />
...
<img src="https://github.com/GyuHo123/JHelper/blob/main/images/CONTRIBUTING/contributing_3.png?raw=true" alt="Pull Request 화면" width="800" />
...
# Trouble Shooting
* [J-Helper 알려진 문제와 해결방법 페이지](https://jbnu-jedutools.github.io/document/JHelper/devManual/Troubleshooting)를 참조하여 해결하세요
