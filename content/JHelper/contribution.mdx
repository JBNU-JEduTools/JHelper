...
로컬에서 변경사항을 커밋하고 자신의 원격 저장소에 푸시한 후, 원본 저장소로 Pull Request를 생성하는 방법을 안내합니다.
...
<img src="https://github.com/GyuHo123/JHelper/blob/main/images/CONTRIBUTING/contributing_3.png?raw=true" width="100%" alt="Pull Request 화면" />
