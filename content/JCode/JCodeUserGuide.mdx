---
title: 'JCode 사용자 설치 가이드'
description: 'This is the meta description for this page'
slug: 'JHelper/JCode/UserGuide'
---

## 설치

1. **먼저, JCloud 인스턴스를 생성합니다.** 

    ❗JCloud 설치 방법은 아래 문서를 참고해주세요

    [JCloud 인스턴스 생성 매뉴얼.pdf](./jcloud.creating.instance.student.2019.v2.pptx.pdf)
...
2. **터미널 또는 Putty와 같은 SSH도구를 통해 JCloud 인스턴스에 접속합니다.** 
    ...
    <img src="./images/2.png" width="600px" height="auto"/> <br/><br/><br/>
...
3. **아래 명령어를 통해 JCode 저장소를 Clone합니다.**
    ...
    <img src="./images/3.png" width="600px" height="auto"/> <br/><br/><br/>
...
4. **아래 명령어를 통해 JCode 디렉터리로 이동 후, 설치스크립트를 실행합니다.**
    ...
    <img src="./images/4.png" width="600px" height="auto"/> <br/><br/><br/>
    ...
    <img src="./images/5.png" width="600px" height="auto"/> <br/><br/><br/>
...
5. **아래 명령어를 통해 Code Server를 실행합니다.**
    ...
    <img src="./images/6.png" width="600px" height="auto"/> <br/><br/><br/>
