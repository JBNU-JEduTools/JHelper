...
<img src="./1.png" width="600px" height="300px"/> <br /> <br /> <br />
...
2. **터미널 또는 Putty와 같은 SSH도구를 통해 JCloud 인스턴스에 접속합니다.** 
    ...
    <img src="./2.png" width="600px" height="auto"/> <br/><br/><br/>
...
3. **아래 명령어를 통해 JCode 저장소를 Clone합니다.**
    ...
    <img src="./3.png" width="600px" height="auto"/> <br/><br/><br/>
...
4. **아래 명령어를 통해 JCode 디렉터리로 이동 후, 설치스크립트를 실행합니다.**
    ...
    <img src="./4.png" width="600px" height="auto"/> <br/><br/><br/>
    ...
    <img src="./5.png" width="600px" height="auto"/> <br/><br/><br/>
...
5. **아래 명령어를 통해 Code Server를 실행합니다.**
    ...
    <img src="./6.png" width="600px" height="auto"/> <br/><br/><br/>
